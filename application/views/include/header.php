  ...
  <body class="page-profile">
    ...
    <header class="navbar navbar-header navbar-header-fixed">
      ...
      <div class="navbar-brand">
        <a href="<?=base_url()?>" class="df-logo">Indian<span>SmartHub</span></a>
      </div><!-- navbar-brand -->
      <div id="navbarMenu" class="navbar-menu-wrapper">
		...
		<li class="nav-item"><a href="<?=base_url('view/index')?>" class="nav-link"><i data-feather="box"></i>Compliance</a></li>
		<li class="nav-item"><a href="<?=base_url('view/adminUser')?>" class="nav-link"><i data-feather="box"></i>Users</a></li>
		<li class="nav-item"><a href="<?=base_url('view/orgChart')?>" class="nav-link"><i data-feather="box"></i>Reporting Structure</a></li>
		<li class="nav-item"><a href="<?=base_url('view/adminCustomer')?>" class="nav-link"><i data-feather="box"></i>Customers</a></li>
		<li class="nav-item"><a href="<?=base_url('view/masterData')?>" class="nav-link"><i data-feather="box"></i>Master Data</a></li>
		<li class="nav-item"><a href="<?=base_url('view/adminForms')?>" class="nav-link"><i data-feather="box"></i>Forms</a></li>
		<li class="nav-item"><a href="<?=base_url('view/adminReports')?>" class="nav-link"><i data-feather="box"></i>Reports</a></li>
      ...
      <div class="navbar-right">
        ...
        <div class="dropdown dropdown-profile">
          ...
          <div class="dropdown-menu dropdown-menu-right tx-13">
            ...
            <a href="<?=base_url()?>view/adminProfile" class="dropdown-item"><i data-feather="edit-3"></i> My Profile</a>
            <a href="<?=base_url('view/admin_Change_Password')?>" class="dropdown-item"><i data-feather="user"></i> Change password</a>
