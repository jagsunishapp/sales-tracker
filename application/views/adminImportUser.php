    ...
    <div class="content content-fixed">
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
		...
		<div class="card">
		<div class="card-body">
		<form action="<?=base_url('Sales_tracker/adminImportUser')?>" method="post" enctype="multipart/form-data">
		<input type="file" name="data_import" class="form-control"/><br>
		<input type="submit" value="submit" name="submit" class="btn btn-info"/>
		</form>

		<br><br>
		<p class="text-center"><a href="<?=base_url()?>excel/userdetails.csv" download>Click here to download sample file </a></p>
