...
?>
    ...
    <div class="content content-fixed">
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
		...
		<div class="card">
			<div class="card-body">
			<span style="color:green;font-weight: bold;"><?=$this->session->flashdata('cust_sucs')?></span>
			<span style="color:red;font-weight: bold;"><?=$this->session->flashdata('cust_err')?></span>
			<form method="post" action="<?=base_url('sales_tracker/update_customerAdmin')?>">
			<div class="row">
				<div class="col-md-6">
					 <div class="form-group">
						<label for="name">Customer Name:</label>
						<input type="text" class="form-control" name="name" id="name" value="<?=$c['customer_name']?>">
						<input type="hidden" class="form-control" name="cust_id" id="cust_id" value="<?=$c['customer_id']?>">
					 ...
					 <div class="form-group">
						<label for="Territory">Territory:</label>
							  <select class="form-control" id="sel1" name="territory">
							  	<option value="<?=$c['territory']?>"><?=$c['territory']?></option>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="text" class="form-control" name="print_as" id="print_as" value="<?=$c['customer_print_as']?>">
					  </div>
				</div>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="text" class="form-control" id="loc_ident" name="loc_ident" value="<?=$c['office_location']?>">
				...
				<div class="col-md-12">
					 <div class="form-group">
						...
						<textarea class="form-control" rows="3" id="address" name="address"><?=$c['address']?></textarea>
				...
				<div class="col-md-3">
					 <div class="form-group">
						...
						<input type="text" class="form-control" id="latbox" name="lat" value="<?=$lat_long[0]?>">
					  </div>
				</div>
				<div class="col-md-3">
					 <div class="form-group">
						<label for="lat_long">Longitude :</label>
						<input type="text" class="form-control" id="lngbox" name="long" value="<?=$lat_long[1]?>">
					  </div>
				</div>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="number" class="form-control" id="phone" name="phone" value="<?=$c['phone1']?>">
					  </div>
				</div>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="number" class="form-control" id="phone2" name="phone2" value="<?=$c['phone2']?>">
					  </div>
				</div>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="number" class="form-control" id="phone3" name="phone3" value="<?=$c['phone3']?>">
					  </div>
				</div>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="text" class="form-control" id="fax" name="fax" value="<?=$c['fax1']?>">
					  </div>
				</div>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="text" class="form-control" id="fax2" name="fax2" value="<?=$c['fax1']?>">
					  </div>
				</div>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="email" class="form-control" id="email2" name="email2" value="<?=$c['email2']?>">
					  </div>
				</div>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="email" class="form-control" id="email3" name="email3" value="<?=$c['email3']?>">
					  </div>
				</div>
				...
				<div class="col-md-6">
					 <div class="form-group">
						...
						<input type="text" class="form-control" id="website" name="website" value="<?=$c['website']?>">
					  </div>
				</div>
