<div class="content content-fixed">
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <span style="color:green;font-weight: bold;font-size: 15px;"><?=$this->session->flashdata('imprt_succs')?></span>
        <div class="row row-xs" style="padding-bottom:30px;">
		<div class="col-md-6 offset-md-3">
		<div class="card">
		<div class="card-body">
		<form method="post" action="<?=base_url('sales_tracker/adm_import_cst')?>" enctype="multipart/form-data">
		<input type="file" name="cust" class="form-control"/><br>
		<input type="submit" value="submit" class="btn btn-info" name="imprt_cst"/>
		</form>

		<br><br>
		<p class="text-center"><a href="<?=base_url()?>excel/customers.csv" download>Click here to download sample file </a></p>
