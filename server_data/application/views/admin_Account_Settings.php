    ...
    <tbody>
      <tr>
	    ...
	    <tr>
        <td>Allow Timeout For All users</td>
        <td><input type="checkbox" /></td>        
      </tr>
        ...
        <td><input type="checkbox" /></td>        
	      ...
	      <tr>
        <td>Allow Pin Location</td>
        <td><input type="checkbox" /></td>        
      </tr>
	  
	   <tr>
        <td>Allow Check-In Check-out</td>
        <td><input type="checkbox" /></td>        
      </tr>
	  
	    <tr>
        <td>Allow Customer Location Edit</td>
        <td><input type="checkbox" /></td>        
      </tr>
	  
	    <tr>
        <td>Location Intercal (In Minute)</td>
        <td>
		...
		<td>        
	       ...
	       <tr>
        <td colspan="2"><button class="btn btn-info">Save</button>
