...
.tabcontent {
  ...
  <body class="page-profile">
    ...
    <div class="row row-xs" style="padding-bottom:30px;">
		...
		<div class="card">
		<div class="card-body">
		<form action="<?=base_url('Sales_tracker/masterDataImportPurposeCategory')?>" method="post" enctype="multipart/form-data">
		...
		<br><br>
		<p class="text-center"><a href="<?=base_url()?>excel/purposecsv.csv" download>Click here to download sample file </a></p>
