  ...
  <body class="page-profile">
    ...
    <header class="navbar navbar-header navbar-header-fixed">
      ...
      <div id="navbarMenu" class="navbar-menu-wrapper">
		...
		<li class="nav-item"><a href="<?=base_url('Sales_tracker/index')?>" class="nav-link"><i data-feather="box"></i>Compliance</a></li>
		<li class="nav-item"><a href="<?=base_url('Sales_tracker/view/adminUser')?>" class="nav-link"><i data-feather="box"></i>Users</a></li>
		<li class="nav-item"><a href="<?=base_url('Sales_tracker/view/orgChart')?>" class="nav-link"><i data-feather="box"></i>Reporting Structure</a></li>
		<li class="nav-item"><a href="<?=base_url('Sales_tracker/view/adminCustomer')?>" class="nav-link"><i data-feather="box"></i>Customers</a></li>
		<li class="nav-item"><a href="<?=base_url('Sales_tracker/view/masterData')?>" class="nav-link"><i data-feather="box"></i>Master Data</a></li>
		<li class="nav-item"><a href="<?=base_url('Sales_tracker/view/adminForms')?>" class="nav-link"><i data-feather="box"></i>Forms</a></li>
		<li class="nav-item"><a href="<?=base_url('Sales_tracker/view/adminReports')?>" class="nav-link"><i data-feather="box"></i>Reports</a></li>
      ...
      <div class="navbar-right">
        ...
        <div class="dropdown dropdown-profile">
          <a href="#" class="dropdown-link" data-toggle="dropdown" data-display="static">
            <div class="avatar avatar-sm"><img src="<?=base_url()?>img/<?=$img?>" class="rounded-circle" alt=""></div>
          </a><!-- dropdown-link -->
          <div class="dropdown-menu dropdown-menu-right tx-13">
            ...
            <a href="<?=base_url()?>sales_tracker/adminProfile" class="dropdown-item"><i data-feather="edit-3"></i> My Profile</a>
            <a href="<?=base_url('sales_tracker/admin_Change_Password')?>" class="dropdown-item"><i data-feather="user"></i> Change password</a>
            <div class="dropdown-divider"></div>
           
            <!-- <a href="<?=base_url('sales_tracker/admin_Account_Settings')?>" class="dropdown-item"><i data-feather="settings"></i>Account Settings</a> -->
